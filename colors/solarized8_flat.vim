...
" Last Updated: Tue 13 Apr 2021 11:48:28 AM EDT
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#184956', '#fa5750', '#75b938', '#dbb32d', '#4695f7', '#f275be', '#41c7b9', '#eee8d5', '#103c48', '#ed8649', '#72898f', '#2d5b69', '#adbcbc', '#af88eb', '#cad8d9', '#fdf6e3']
    if has('nvim')
      ...
      let g:terminal_color_8 = '#103c48'
      let g:terminal_color_9 = '#ed8649'
      let g:terminal_color_10 = '#72898f'
      let g:terminal_color_11 = '#2d5b69'
      let g:terminal_color_12 = '#adbcbc'
      let g:terminal_color_13 = '#af88eb'
      let g:terminal_color_14 = '#cad8d9'
      let g:terminal_color_15 = '#fdf6e3'
    endif
    if s:termtrans
      hi Normal guifg=#adbcbc guibg=NONE gui=NONE cterm=NONE
      hi CursorLine guifg=NONE guibg=NONE guisp=#72898f gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
      hi Terminal guifg=fg guibg=NONE gui=NONE cterm=NONE
      hi ToolbarButton guifg=#cad8d9 guibg=NONE gui=NONE cterm=NONE
      hi ToolbarLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    else " opaque
      hi Normal guifg=#adbcbc guibg=#103c48 gui=NONE cterm=NONE
      hi NormalFloat guifg=#75b938 guibg=#000000 gui=NONE cterm=NONE
      hi CursorLine guifg=NONE guibg=#000000 gui=NONE cterm=NONE
      hi Terminal guifg=fg guibg=#103c48 gui=NONE cterm=NONE
      hi ToolbarButton guifg=#cad8d9 guibg=#184956 gui=NONE cterm=NONE
      hi ToolbarLine guifg=NONE guibg=#184956 gui=NONE cterm=NONE
    endif
    if get(g:, 'solarized_visibility', '') ==# 'high'
      hi CursorLineNr guifg=#ed8649 guibg=NONE gui=NONE cterm=NONE
      hi NonText guifg=#ed8649 guibg=NONE gui=NONE cterm=NONE
      hi SpecialKey guifg=#ed8649 guibg=NONE gui=reverse cterm=reverse
      hi SpellBad guifg=#af88eb guibg=#eee8d5 gui=NONE cterm=NONE
      hi SpellCap guifg=#af88eb guibg=#eee8d5 gui=NONE cterm=NONE
      hi SpellLocal guifg=#dbb32d guibg=#eee8d5 gui=NONE cterm=NONE
      hi SpellRare guifg=#41c7b9 guibg=#eee8d5 gui=NONE cterm=NONE
      hi Title guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    elseif get(g:, 'solarized_visibility', '') ==# 'low'
      hi CursorLineNr guifg=#72898f guibg=NONE gui=NONE cterm=NONE
      hi NonText guifg=#184956 guibg=NONE gui=NONE cterm=NONE
      hi SpecialKey guifg=#184956 guibg=NONE gui=reverse cterm=reverse
      hi SpellBad guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
      hi SpellCap guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
      hi SpellLocal guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
      hi SpellRare guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
      hi Title guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    else " normal visibility
      hi CursorLineNr guifg=#adbcbc guibg=NONE gui=NONE cterm=NONE
      hi NonText guifg=#2d5b69 guibg=NONE gui=NONE cterm=NONE
      hi SpecialKey guifg=#2d5b69 guibg=#184956 gui=NONE cterm=NONE
      hi SpellBad guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
      hi SpellCap guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
      hi SpellLocal guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
      hi SpellRare guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
      hi Title guifg=#ed8649 guibg=NONE gui=NONE cterm=NONE
    endif
    if get(g:, 'solarized_old_cursor_style', 0)
      hi Cursor guifg=#103c48 guibg=#adbcbc gui=NONE cterm=NONE
    else
      hi Cursor guifg=#103c48 guibg=#00ff00 gui=NONE cterm=NONE
    endif
    if get(g:, 'solarized_diffmode', '') ==# 'high'
      hi DiffAdd guifg=#75b938 guibg=NONE gui=reverse cterm=reverse
      hi DiffChange guifg=#dbb32d guibg=NONE gui=reverse cterm=reverse
      hi DiffDelete guifg=#fa5750 guibg=NONE gui=reverse cterm=reverse
      hi DiffText guifg=#4695f7 guibg=NONE gui=reverse cterm=reverse
    elseif get(g:, 'solarized_diffmode', '') ==# 'low'
      hi DiffAdd guifg=#75b938 guibg=NONE guisp=#75b938 gui=NONE cterm=NONE
      hi DiffChange guifg=#dbb32d guibg=NONE guisp=#dbb32d gui=NONE cterm=NONE
      hi DiffDelete guifg=#fa5750 guibg=NONE gui=NONE cterm=NONE
      hi DiffText guifg=#4695f7 guibg=NONE guisp=#4695f7 gui=NONE cterm=NONE
    else " normal diffmode
      hi DiffAdd guifg=#75b938 guibg=#184956 guisp=#75b938 gui=NONE cterm=NONE
      hi DiffChange guifg=#dbb32d guibg=#184956 guisp=#dbb32d gui=NONE cterm=NONE
      hi DiffDelete guifg=#fa5750 guibg=#184956 gui=NONE cterm=NONE
      hi DiffText guifg=#4695f7 guibg=#184956 guisp=#4695f7 gui=NONE cterm=NONE
    endif
    if get(g:, 'solarized_statusline', '') ==# 'low'
      hi StatusLine guifg=#184956 guibg=#cad8d9 gui=reverse cterm=reverse
      hi StatusLineNC guifg=#184956 guibg=#72898f gui=reverse cterm=reverse
      hi TabLineSel guifg=#cad8d9 guibg=#184956 gui=NONE cterm=NONE
      hi NormalMode guifg=#184956 guibg=#cad8d9 gui=reverse cterm=reverse
    else
      hi StatusLine guifg=#184956 guibg=#eee8d5 gui=reverse cterm=reverse
      hi StatusLineNC guifg=#184956 guibg=#cad8d9 gui=reverse cterm=reverse
      hi TabLineSel guifg=#eee8d5 guibg=#184956 gui=NONE cterm=NONE
      hi NormalMode guifg=#184956 guibg=#eee8d5 gui=reverse cterm=reverse
    endif
    hi ColorColumn guifg=NONE guibg=#184956 gui=NONE cterm=NONE
    hi Conceal guifg=#fdf6e3 guibg=NONE gui=NONE cterm=NONE
    hi CursorColumn guifg=NONE guibg=#184956 gui=NONE cterm=NONE
    hi Directory guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi EndOfBuffer guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi ErrorMsg guifg=#fa5750 guibg=#fdf6e3 gui=reverse cterm=reverse
    hi FoldColumn guifg=#adbcbc guibg=NONE gui=NONE cterm=NONE
    hi Folded guifg=#adbcbc guibg=NONE guisp=#103c48 gui=NONE cterm=NONE
    hi IncSearch guifg=#ed8649 guibg=NONE gui=standout cterm=standout
    hi LineNr guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    hi MatchParen guifg=NONE guibg=#000000 gui=NONE cterm=NONE
    hi ModeMsg guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi MoreMsg guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi Pmenu guifg=#adbcbc guibg=#184956 gui=NONE cterm=NONE
    hi PmenuSbar guifg=NONE guibg=#184956 gui=NONE cterm=NONE
    hi PmenuSel guifg=#eee8d5 guibg=#72898f gui=NONE cterm=NONE
    hi PmenuThumb guifg=NONE guibg=#72898f gui=NONE cterm=NONE
    hi Question guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi Search guifg=#dbb32d guibg=NONE gui=reverse cterm=reverse
    hi SignColumn guifg=#adbcbc guibg=NONE gui=NONE cterm=NONE
    hi TabLine guifg=#72898f guibg=#184956 gui=NONE cterm=NONE
    hi TabLineFill guifg=#72898f guibg=#184956 gui=NONE cterm=NONE
    hi VertSplit guifg=#184956 guibg=#184956 gui=NONE cterm=NONE
    hi Visual guifg=#72898f guibg=#103c48 gui=reverse cterm=reverse
    hi VisualNOS guifg=NONE guibg=#184956 gui=reverse cterm=reverse
    hi WarningMsg guifg=#ed8649 guibg=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#2d5b69 guibg=#eee8d5 gui=reverse cterm=reverse
    ...
    hi Error guifg=#fa5750 guibg=#fdf6e3 gui=reverse cterm=reverse
    hi Identifier guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi Ignore guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi PreProc guifg=#ed8649 guibg=NONE gui=NONE cterm=NONE
    hi Special guifg=#ed8649 guibg=NONE gui=NONE cterm=NONE
    hi Statement guifg=#75b938 guibg=NONE gui=NONE cterm=NONE
    hi Todo guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi Type guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi Underlined guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
    hi InsertMode guifg=#184956 guibg=#41c7b9 gui=reverse cterm=reverse
    hi ReplaceMode guifg=#184956 guibg=#ed8649 gui=reverse cterm=reverse
    hi VisualMode guifg=#184956 guibg=#f275be gui=reverse cterm=reverse
    hi CommandMode guifg=#184956 guibg=#f275be gui=reverse cterm=reverse
    if !s:italics
      hi Comment gui=NONE cterm=NONE
    endif
    if has('nvim')
      hi! link TermCursor Cursor
      hi TermCursorNC guifg=#103c48 guibg=#72898f gui=NONE cterm=NONE
    endif
    ...
    hi vimCommentString guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
    hi vimCommand guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi vimCmdSep guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi helpExample guifg=#cad8d9 guibg=NONE gui=NONE cterm=NONE
    hi helpOption guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi helpNote guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi helpVim guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi helpHyperTextJump guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi helpHyperTextEntry guifg=#75b938 guibg=NONE gui=NONE cterm=NONE
    hi vimIsCommand guifg=#2d5b69 guibg=NONE gui=NONE cterm=NONE
    hi vimSynMtchOpt guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi vimSynType guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi vimHiLink guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi vimHiGroup guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi vimGroup guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi! link diffAdded Statement
    hi! link diffLine Identifier
    hi gitcommitComment guifg=#72898f guibg=NONE gui=italic cterm=italic
    hi! link gitcommitUntracked gitcommitComment
    hi! link gitcommitDiscarded gitcommitComment
    hi! link gitcommitSelected gitcommitComment
    hi gitcommitUnmerged guifg=#75b938 guibg=NONE gui=bold cterm=bold
    hi gitcommitOnBranch guifg=#72898f guibg=NONE gui=bold cterm=bold
    hi gitcommitBranch guifg=#f275be guibg=NONE gui=bold cterm=bold
    hi! link gitcommitNoBranch gitcommitBranch
    hi gitcommitdiscardedtype guifg=#fa5750 guibg=NONE gui=NONE cterm=NONE
    hi gitcommitselectedtype guifg=#75b938 guibg=NONE gui=NONE cterm=NONE
    hi gitcommitHeader guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    hi gitcommitUntrackedFile guifg=#41c7b9 guibg=NONE gui=bold cterm=bold
    hi gitcommitDiscardedFile guifg=#fa5750 guibg=NONE gui=bold cterm=bold
    hi gitcommitSelectedFile guifg=#75b938 guibg=NONE gui=bold cterm=bold
    hi gitcommitUnmergedFile guifg=#dbb32d guibg=NONE gui=bold cterm=bold
    hi gitcommitFile guifg=#adbcbc guibg=NONE gui=bold cterm=bold
    hi! link gitcommitDiscardedArrow gitcommitDiscardedFile
    hi! link gitcommitSelectedArrow gitcommitSelectedFile
    hi! link gitcommitUnmergedArrow gitcommitUnmergedFile
    hi htmlTag guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    hi htmlEndTag guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    hi htmlTagN guifg=#cad8d9 guibg=NONE gui=bold cterm=bold
    hi htmlTagName guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi htmlSpecialTagName guifg=#4695f7 guibg=NONE gui=italic cterm=italic
    hi htmlArg guifg=#2d5b69 guibg=NONE gui=NONE cterm=NONE
    hi javaScript guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi! link jsFuncCall Function
    hi perlHereDoc guifg=#cad8d9 guibg=#103c48 gui=NONE cterm=NONE
    hi perlVarPlain guifg=#dbb32d guibg=#103c48 gui=NONE cterm=NONE
    hi perlStatementFileDesc guifg=#41c7b9 guibg=#103c48 gui=NONE cterm=NONE
    hi texstatement guifg=#41c7b9 guibg=#103c48 gui=NONE cterm=NONE
    hi texmathzonex guifg=#dbb32d guibg=#103c48 gui=NONE cterm=NONE
    hi texmathmatcher guifg=#dbb32d guibg=#103c48 gui=NONE cterm=NONE
    hi texreflabel guifg=#dbb32d guibg=#103c48 gui=NONE cterm=NONE
    hi rubyDefine guifg=#cad8d9 guibg=#103c48 gui=bold cterm=bold
    hi! link rubySymbol Type
    hi rubyBoolean guifg=#f275be guibg=#103c48 gui=NONE cterm=NONE
    hi cPreCondit guifg=#ed8649 guibg=NONE gui=NONE cterm=NONE
    hi VarId guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi ConId guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi hsImport guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi hsString guifg=#2d5b69 guibg=NONE gui=NONE cterm=NONE
    hi hsStructure guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi hs_hlFunctionName guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi hsStatement guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi hsImportLabel guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi hs_OpFunctionName guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi hs_DeclareFunction guifg=#ed8649 guibg=NONE gui=NONE cterm=NONE
    hi hsVarSym guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi hsType guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi hsTypedef guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi hsModuleName guifg=#75b938 guibg=NONE gui=NONE cterm=NONE
    hi! link hsImportParams Delimiter
    hi! link hsDelimTypeExport Delimiter
    hi! link hsModuleStartLabel hsStructure
    hi! link hsModuleWhereLabel hsModuleStartLabel
    hi hsNiceOperator guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi hsniceoperator guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    if !s:italics
    ...
    hi pandocTitleBlock guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocTitleBlockTitle guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocTitleComment guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocComment guifg=#72898f guibg=NONE gui=italic cterm=italic
    hi pandocVerbatimBlock guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi! link pandocVerbatimBlockDeep pandocVerbatimBlock
    hi! link pandocCodeBlock pandocVerbatimBlock
    hi! link pandocCodeBlockDelim pandocVerbatimBlock
    hi pandocBlockQuote guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocBlockQuoteLeader1 guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocBlockQuoteLeader2 guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
    hi pandocBlockQuoteLeader3 guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi pandocBlockQuoteLeader4 guifg=#fa5750 guibg=NONE gui=NONE cterm=NONE
    hi pandocBlockQuoteLeader5 guifg=#adbcbc guibg=NONE gui=NONE cterm=NONE
    hi pandocBlockQuoteLeader6 guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    hi pandocListMarker guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi pandocListReference guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi pandocDefinitionBlock guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
    hi pandocDefinitionTerm guifg=#af88eb guibg=NONE gui=standout cterm=standout
    hi pandocDefinitionIndctr guifg=#af88eb guibg=NONE gui=bold cterm=bold
    hi pandocEmphasisDefinition guifg=#af88eb guibg=NONE gui=italic cterm=italic
    hi pandocEmphasisNestedDefinition guifg=#af88eb guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisDefinition guifg=#af88eb guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisNestedDefinition guifg=#af88eb guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisEmphasisDefinition guifg=#af88eb guibg=NONE gui=bold cterm=bold
    hi pandocStrikeoutDefinition guifg=#af88eb guibg=NONE gui=reverse cterm=reverse
    hi pandocVerbatimInlineDefinition guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
    hi pandocSuperscriptDefinition guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
    hi pandocSubscriptDefinition guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
    hi pandocTable guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocTableStructure guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi! link pandocTableStructureTop pandocTableStructre
    hi! link pandocTableStructureEnd pandocTableStructre
    hi pandocTableZebraLight guifg=#4695f7 guibg=#103c48 gui=NONE cterm=NONE
    hi pandocTableZebraDark guifg=#4695f7 guibg=#184956 gui=NONE cterm=NONE
    hi pandocEmphasisTable guifg=#4695f7 guibg=NONE gui=italic cterm=italic
    hi pandocEmphasisNestedTable guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisTable guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisNestedTable guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisEmphasisTable guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocStrikeoutTable guifg=#4695f7 guibg=NONE gui=reverse cterm=reverse
    hi pandocVerbatimInlineTable guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocSuperscriptTable guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocSubscriptTable guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocHeadingMarker guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocEmphasisHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocEmphasisNestedHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisNestedHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisEmphasisHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocStrikeoutHeading guifg=#ed8649 guibg=NONE gui=reverse cterm=reverse
    hi pandocVerbatimInlineHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocSuperscriptHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocSubscriptHeading guifg=#ed8649 guibg=NONE gui=bold cterm=bold
    hi pandocLinkDelim guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    hi pandocLinkLabel guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocLinkText guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocLinkURL guifg=#2d5b69 guibg=NONE gui=NONE cterm=NONE
    hi pandocLinkTitle guifg=#2d5b69 guibg=NONE gui=NONE cterm=NONE
    hi pandocLinkTitleDelim guifg=#72898f guibg=NONE guisp=#2d5b69 gui=NONE cterm=NONE
    hi pandocLinkDefinition guifg=#41c7b9 guibg=NONE guisp=#2d5b69 gui=NONE cterm=NONE
    hi pandocLinkDefinitionID guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocImageCaption guifg=#af88eb guibg=NONE gui=bold cterm=bold
    hi pandocFootnoteLink guifg=#75b938 guibg=NONE gui=NONE cterm=NONE
    hi pandocFootnoteDefLink guifg=#75b938 guibg=NONE gui=bold cterm=bold
    hi pandocFootnoteInline guifg=#75b938 guibg=NONE gui=bold cterm=bold
    hi pandocFootnote guifg=#75b938 guibg=NONE gui=NONE cterm=NONE
    hi pandocCitationDelim guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi pandocCitation guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi pandocCitationID guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi pandocCitationRef guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi pandocStyleDelim guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    hi pandocEmphasis guifg=#adbcbc guibg=NONE gui=italic cterm=italic
    hi pandocEmphasisNested guifg=#adbcbc guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasis guifg=#adbcbc guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisNested guifg=#adbcbc guibg=NONE gui=bold cterm=bold
    hi pandocStrongEmphasisEmphasis guifg=#adbcbc guibg=NONE gui=bold cterm=bold
    hi pandocStrikeout guifg=#72898f guibg=NONE gui=reverse cterm=reverse
    hi pandocVerbatimInline guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    hi pandocSuperscript guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
    hi pandocSubscript guifg=#af88eb guibg=NONE gui=NONE cterm=NONE
    hi pandocRule guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocRuleLine guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    hi pandocEscapePair guifg=#fa5750 guibg=NONE gui=bold cterm=bold
    hi pandocCitationRef guifg=#f275be guibg=NONE gui=NONE cterm=NONE
    hi pandocNonBreakingSpace guifg=#fa5750 guibg=NONE gui=reverse cterm=reverse
    hi! link pandocEscapedCharacter pandocEscapePair
    hi! link pandocLineBreak pandocEscapePair
    hi pandocMetadataDelim guifg=#72898f guibg=NONE gui=NONE cterm=NONE
    hi pandocMetadata guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocMetadataKey guifg=#4695f7 guibg=NONE gui=NONE cterm=NONE
    hi pandocMetadata guifg=#4695f7 guibg=NONE gui=bold cterm=bold
    ...
    if get(g:, 'solarized_statusline', '') ==# 'flat'
      hi ALEErrorSign guifg=#fa5750 guibg=NONE gui=bold cterm=bold
      hi ALEInfoSign guifg=#41c7b9 guibg=NONE gui=bold cterm=bold
      hi ALEWarningSign guifg=#dbb32d guibg=NONE gui=bold cterm=bold
      hi ALEErrorSignLineNr guifg=#fa5750 guibg=NONE gui=NONE cterm=NONE
      hi ALEInfoSignLineNr guifg=#41c7b9 guibg=NONE gui=NONE cterm=NONE
      hi ALEWarningSignLineNr guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
    else
      if get(g:, 'ale_sign_highlight_linenrs', '') ==# 1
        hi ALEErrorSign guifg=#184956 guibg=#fa5750 gui=bold cterm=bold
        hi ALEInfoSign guifg=#184956 guibg=#41c7b9 gui=bold cterm=bold
        hi ALEWarningSign guifg=#184956 guibg=#dbb32d gui=bold cterm=bold
      else
        hi ALEErrorSign guifg=#fa5750 guibg=#184956 gui=bold cterm=bold
        hi ALEInfoSign guifg=#41c7b9 guibg=#184956 gui=bold cterm=bold
        hi ALEWarningSign guifg=#dbb32d guibg=#184956 gui=bold cterm=bold
      endif
      hi ALEErrorSignLineNr guifg=#184956 guibg=#fa5750 gui=NONE cterm=NONE
      hi ALEInfoSignLineNr guifg=#184956 guibg=#41c7b9 gui=NONE cterm=NONE
      hi ALEWarningSignLineNr guifg=#184956 guibg=#dbb32d gui=NONE cterm=NONE
    endif
    hi ALEError guifg=#fa5750 guibg=NONE guisp=#fa5750 gui=undercurl cterm=undercurl
    hi ALEErrorLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi ALEInfo guifg=#41c7b9 guibg=NONE guisp=#41c7b9 gui=undercurl cterm=undercurl
    hi ALEInfoLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi ALEWarning guifg=#dbb32d guibg=NONE guisp=#dbb32d gui=undercurl cterm=undercurl
...
if s:t_Co >= 256
  if &background ==# 'dark'
    if s:termtrans
      ...
      hi ToolbarButton ctermfg=247 ctermbg=NONE cterm=NONE
      ...
      hi NormalFloat ctermfg=106 ctermbg=16 cterm=NONE
      hi CursorLine ctermfg=NONE ctermbg=16 cterm=NONE
      hi Terminal ctermfg=fg ctermbg=235 cterm=NONE
      hi ToolbarButton ctermfg=247 ctermbg=236 cterm=NONE
      hi ToolbarLine ctermfg=NONE ctermbg=236 cterm=NONE
    endif
    if get(g:, 'solarized_visibility', '') ==# 'high'
      hi CursorLineNr ctermfg=166 ctermbg=NONE cterm=NONE
      hi NonText ctermfg=166 ctermbg=NONE cterm=NONE
      hi SpecialKey ctermfg=166 ctermbg=NONE cterm=reverse
      hi SpellBad ctermfg=61 ctermbg=254 cterm=NONE
      hi SpellCap ctermfg=61 ctermbg=254 cterm=NONE
      hi SpellLocal ctermfg=136 ctermbg=254 cterm=NONE
      hi SpellRare ctermfg=37 ctermbg=254 cterm=NONE
    ...
    elseif get(g:, 'solarized_visibility', '') ==# 'low'
      ...
      hi SpellBad ctermfg=61 ctermbg=NONE cterm=NONE
      hi SpellCap ctermfg=61 ctermbg=NONE cterm=NONE
      hi SpellLocal ctermfg=136 ctermbg=NONE cterm=NONE
      hi SpellRare ctermfg=37 ctermbg=NONE cterm=NONE
      hi Title ctermfg=242 ctermbg=NONE cterm=NONE
    else " normal visibility
      hi CursorLineNr ctermfg=246 ctermbg=NONE cterm=NONE
      hi NonText ctermfg=66 ctermbg=NONE cterm=NONE
      hi SpecialKey ctermfg=66 ctermbg=236 cterm=NONE
      hi SpellBad ctermfg=61 ctermbg=NONE cterm=NONE
      hi SpellCap ctermfg=61 ctermbg=NONE cterm=NONE
      hi SpellLocal ctermfg=136 ctermbg=NONE cterm=NONE
      hi SpellRare ctermfg=37 ctermbg=NONE cterm=NONE
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      ...
      hi Cursor ctermfg=235 ctermbg=46 cterm=NONE
    endif
    if get(g:, 'solarized_diffmode', '') ==# 'high'
    ...
    if get(g:, 'solarized_statusline', '') ==# 'low'
      hi StatusLine ctermfg=236 ctermbg=247 cterm=reverse
      hi StatusLineNC ctermfg=236 ctermbg=242 cterm=reverse
      hi TabLineSel ctermfg=247 ctermbg=236 cterm=NONE
      hi NormalMode ctermfg=236 ctermbg=247 cterm=reverse
    else
    ...
    hi Conceal ctermfg=230 ctermbg=NONE cterm=NONE
    ...
    hi MatchParen ctermfg=NONE ctermbg=16 cterm=NONE
    ...
    hi Error ctermfg=160 ctermbg=230 cterm=reverse
    ...
    hi Todo ctermfg=162 ctermbg=NONE cterm=NONE
    hi Type ctermfg=136 ctermbg=NONE cterm=NONE
    hi Underlined ctermfg=61 ctermbg=NONE cterm=NONE
    hi InsertMode ctermfg=236 ctermbg=37 cterm=reverse
    hi ReplaceMode ctermfg=236 ctermbg=166 cterm=reverse
    hi VisualMode ctermfg=236 ctermbg=162 cterm=reverse
    hi CommandMode ctermfg=236 ctermbg=162 cterm=reverse
    if !s:italics
...
if s:t_Co >= 16
  if &background ==# 'dark'
    if s:termtrans
      ...
      hi CursorLine ctermfg=NONE ctermbg=NONE cterm=underline
      hi Terminal ctermfg=fg ctermbg=NONE cterm=NONE
      hi ToolbarButton ctermfg=14 ctermbg=NONE cterm=NONE
      hi ToolbarLine ctermfg=NONE ctermbg=NONE cterm=NONE
    else " opaque
      hi Normal ctermfg=12 ctermbg=8 cterm=NONE
      hi NormalFloat ctermfg=2 ctermbg=8 cterm=NONE
      hi CursorLine ctermfg=NONE ctermbg=8 cterm=NONE
      hi Terminal ctermfg=fg ctermbg=8 cterm=NONE
      hi ToolbarButton ctermfg=14 ctermbg=0 cterm=NONE
      hi ToolbarLine ctermfg=NONE ctermbg=0 cterm=NONE
    endif
    if get(g:, 'solarized_visibility', '') ==# 'high'
      hi CursorLineNr ctermfg=9 ctermbg=NONE cterm=NONE
      hi NonText ctermfg=9 ctermbg=NONE cterm=NONE
      hi SpecialKey ctermfg=9 ctermbg=NONE cterm=reverse
      hi SpellBad ctermfg=13 ctermbg=7 cterm=NONE
      hi SpellCap ctermfg=13 ctermbg=7 cterm=NONE
      hi SpellLocal ctermfg=3 ctermbg=7 cterm=NONE
      hi SpellRare ctermfg=6 ctermbg=7 cterm=NONE
    ...
    elseif get(g:, 'solarized_visibility', '') ==# 'low'
      ...
      hi SpellBad ctermfg=13 ctermbg=NONE cterm=NONE
      hi SpellCap ctermfg=13 ctermbg=NONE cterm=NONE
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      ...
      hi Cursor ctermfg=8 ctermbg=2 cterm=NONE
    endif
    if get(g:, 'solarized_diffmode', '') ==# 'high'
    ...
    if get(g:, 'solarized_statusline', '') ==# 'low'
      ...
      hi NormalMode ctermfg=0 ctermbg=14 cterm=reverse
    else
    ...
    hi InsertMode ctermfg=0 ctermbg=6 cterm=reverse
    hi ReplaceMode ctermfg=0 ctermbg=9 cterm=reverse
    hi VisualMode ctermfg=0 ctermbg=5 cterm=reverse
    hi CommandMode ctermfg=0 ctermbg=5 cterm=reverse
    if !s:italics
      hi Comment cterm=NONE
    endif
    if has('nvim')
