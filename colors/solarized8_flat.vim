...
" Last Updated: Tue 02 Jul 2019 03:22:07 PM EDT
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      ...
      hi Cursor guifg=#fdf6e3 guibg=#00ff00 guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi MatchParen guifg=#002b36 guibg=#ff0000 guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      ...
      hi Cursor ctermfg=230 ctermbg=46 cterm=NONE
    endif
    if get(g:, 'solarized_diffmode', '') ==# 'high'
    ...
    hi MatchParen ctermfg=235 ctermbg=196 cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      ...
      hi Cursor ctermfg=15 ctermbg=2 cterm=NONE
    endif
    if get(g:, 'solarized_diffmode', '') ==# 'high'
    ...
    hi MatchParen ctermfg=8 ctermbg=1 cterm=NONE
